...
export function PageHeader({
  ...
  return (
    <div className={cn(pageHeaderVariants({ spacing }), className)}>
      ...
      {(title || description) && (
        <div className="flex flex-col gap-3 px-3 py-4 md:flex-row md:items-start md:justify-between">
      ...
      {tabs && (
        <div className="flex w-full items-center justify-between border-b border-kumo-line px-3 pb-3">
          <Tabs
            tabs={tabs}
            {...(defaultTab ? { selectedValue: defaultTab } : {})}
