...
export default function Settings() {
  ...
  const updateConfig = (section: keyof ConfigData, field: string, value: any) => { // eslint-disable-line
    setConfig((prev) => ({
      ...prev,
      [section]: {
        ...prev[section],
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure CookieFarm settings and server parameters</p>
        </div>
        ...
        <TabsContent value="flag-checker" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure flag submission settings and communication parameters</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="rounds" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set up match timing, round duration, and schedule</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center">
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 bg-muted rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-3xl font-bold text-primary">{calculateTotalTicks()}</span>
                      <span className="text-lg text-muted-foreground ml-2">ticks</span>
                    </div>
                    <Badge variant="outline">{config.rounds.duration}s per round</Badge>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Manage services that will be monitored during the CTF</CardDescription>
                </div>
        ...
        <TabsContent value="teams" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure team settings and network parameters</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
              ...
              <div className="mt-6 p-4 bg-muted rounded-lg">
                ...
                <div className="space-y-1 text-sm text-muted-foreground">
                  ...
                  <p>
                    Your Team ({config.teams.ownTeamId}): {config.teams.ipFormat.replace("{}", config.teams.ownTeamId)}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Get notified when flags are submitted</p>
                  </div>
                  <Switch
                    checked={config.notifications.flagSubmissionAlerts}
                    onCheckedChange={(checked) => updateConfig("notifications", "flagSubmissionAlerts", checked)}
                  />
                </div>
                <Separator />
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Alert when services go offline</p>
                  </div>
                  <Switch
                    checked={config.notifications.serviceDownAlerts}
                    onCheckedChange={(checked) => updateConfig("notifications", "serviceDownAlerts", checked)}
                  />
                </div>
                <Separator />
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Notify when rounds change</p>
                  </div>
                  <Switch
                    checked={config.notifications.roundChangeNotifications}
                    onCheckedChange={(checked) => updateConfig("notifications", "roundChangeNotifications", checked)}
                  />
                </div>
                <Separator />
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Alert on successful exploits</p>
                  </div>
                  <Switch
                    checked={config.notifications.exploitSuccessAlerts}
                    onCheckedChange={(checked) => updateConfig("notifications", "exploitSuccessAlerts", checked)}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig("security", "apiKey", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
